...
![3 任务定义、数据与评价指标](figures/dataset_distribution.png)
...
![4 总体求解流程](figures/cross_route_workflow.png)
...
![9 Kaiwu 求解、门禁与真机结果](figures/sa_cim_energy.png)
...
![13 求解结果汇总](figures/route_accuracy_comparison.png)
