...
desired_output_list = [measure1, measure1, measure0, measure0, measure1, measure1,
                       measure0, measure0, measure1, measure1, measure0, measure0]       # 有错误的标签
...
file_handle = open('/share/home/sjwu/wlj/project/3-layers/label-error/data/le1-h0.1-g0.7.txt', mode='w')
