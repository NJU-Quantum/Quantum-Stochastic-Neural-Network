...
file_handle = open('/share/home/sjwu/wlj/project/3-layers/random-g/data/gr23-h0-tg-loss', mode='w')
file_handle.write(str(cost_list))
file_handle = open('/share/home/sjwu/wlj/project/3-layers/random-g/data/gr23-h0-tg-sent1', mode='w')
file_handle.write(str(test_cost_sent1_list))
file_handle = open('/share/home/sjwu/wlj/project/3-layers/random-g/data/gr23-h0-tg-sent2', mode='w')
file_handle.write(str(test_cost_sent2_list))
file_handle = open('/share/home/sjwu/wlj/project/3-layers/random-g/data/gr23-h0-tg-sent3', mode='w')
file_handle.write(str(test_cost_sent3_list))
file_handle = open('/share/home/sjwu/wlj/project/3-layers/random-g/data/gr23-h0-tg-sent4', mode='w')
